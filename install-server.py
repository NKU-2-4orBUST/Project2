...
def ldap():
	...
	os.system('rm -f /var/lib/ldap/* && cat ./olc2 > /etc/openldap/slapd.d/cn=config/olcDatabase={2}hdb.ldif && ldapadd -x -D "cn=Manager,dc=cit470,dc=nku,dc=edu" -w Nhy67ujm! -f example.ldif')
