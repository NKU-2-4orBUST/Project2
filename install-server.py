...
def ldap():
	...
	os.system('echo Migrating Users and Groups to LDAP database.... | tee  -a /var/log/ldap_install.log; systemctl start slapd; ldapadd -Y EXTERNAL -H ldapi:// -f /etc/openldap/schema/core.ldif; ldapadd -Y EXTERNAL -H ldapi:// -f /etc/openldap/schema/cosine.ldif; ldapadd -Y EXTERNAL -H ldapi:// -f /etc/openldap/schema/nis.ldif; ldapadd -Y EXTERNAL -H ldapi:// -f /etc/openldap/schema/inetorgperson.ldif; systemctl stop slapd >> /var/log/ldap_install.log 2>&1; chown -R ldap:ldap /var/lib/ldap >> /var/log/ldap_install.log 2>&1; slapadd -v -l /usr/share/migrationtools/base.ldif >> /var/log/ldap_install.log 2>&1; /usr/share/migrationtools/migrate_passwd.pl /etc/passwd > /usr/share/migrationtools/passwd.ldif >> /var/log/ldap_install.log 2>&1; slapadd -v -l /usr/share/migrationtools/passwd.ldif >> /var/log/ldap_install.log 2>&1; /usr/share/migrationtools/migrate_group.pl /etc/group > /usr/share/migrationtools/group.ldif >> /var/log/ldap_install.log 2>&1; slapadd -v -l /usr/share/migrationtools/group.ldif >> /var/log/ldap_install.log 2>&1; chown -R ldap:ldap /var/lib/ldap >> /var/log/ldap_install.log 2>&1; systemctl start slapd >> /var/log/ldap_install.log 2>&1; systemctl -l status slapd >> /var/log/ldap_install.log 2>&1')
